  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <div className="flex flex-col sm:flex-row items-start justify-between gap-4 mb-8">
        ...
        <div
          className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium cursor-pointer transition-all border w-full sm:w-auto"
          style={{
      ...
      {/* Security Audit Trail + Quick Actions Row (Fully Responsive) */}
      <div className="grid grid-cols-12 gap-6 mb-8">
        ...
        <div className="col-span-12 lg:col-span-7">
          ...
          <div
            className="rounded-2xl border overflow-x-auto w-full"
      ...
      {/* Global Ingress Map (Full width on all screen sizes, placed as a top-level row) */}
      <div
        className="rounded-2xl border overflow-hidden mb-8"
        style={{ background: 'var(--bg-card)', borderColor: 'var(--border-primary)', boxShadow: 'var(--shadow-card)' }}
      >
        <p className="text-[10px] tracking-[0.15em] uppercase font-bold px-5 pt-4" style={{ color: 'var(--text-muted)' }}>
          Global Ingress Map
        </p>
        <div
          className="mx-5 my-4 h-40 rounded-xl flex items-end justify-between p-4"
          style={{
            background: 'linear-gradient(135deg, #0f172a, #1e293b)',
            backgroundImage: 'radial-gradient(circle at 30% 50%, rgba(37,99,235,0.15) 0%, transparent 50%), radial-gradient(circle at 70% 30%, rgba(16,185,129,0.12) 0%, transparent 50%)',
          }}
        >
